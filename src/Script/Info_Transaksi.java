...
//  Metode Pencarian Data
    public void cariData(String key){
        ...
        String sql = "SELECT * FROM pesanan WHERE id_pelanggan = ? AND (id_pesanan LIKE ? OR tanggal_pesan LIKE ? OR alamat_kirim LIKE ? OR catatan LIKE ? OR metode_bayar LIKE ? OR total_harga LIKE ? OR status LIKE ?) ";
        try(PreparedStatement ps = AP_Database.con.prepareStatement(sql))
        {

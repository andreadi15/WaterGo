 ...
 * @author asus
 */
public class ADM_Daftar_Produk extends javax.swing.JPanel {
    public ResultSet rs = null;
    private final ADM_Kelola_Produk kelola = new ADM_Kelola_Produk();
 ;
    private String sql;

    
    public ADM_Daftar_Produk() {
        initComponents();              
    }
...
//  Metode Pencarian Data
    public void cariData(String key){
        ...
        sql = "SELECT * FROM produk WHERE id_produk LIKE ? OR nama_produk LIKE ? OR harga LIKE ?";
    ...
    private void kelolaData(){
        ...
        String id_produk = tableContainer.getValueAt(row, 0).toString();
        
        kelola.loadData(id_produk);
